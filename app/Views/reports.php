...
<script>
    ...
    <div class="container-fluid py-5 mb-5 hero-header">
        <div class="container py-5" style="height:50px;">
            <div class="row g-5 align-items-center">
                ...
                <br><br><br><br>
                    <h4 class="mb-3 text-secondary">TRAINING/REPORTS</h4>
                    <h1 class="mb-5 display-3 text-primary">REPORTS</h1>
                </div>
                </div>
                </div>
    </div>
    ...
    <div class="row">
        ...
        <?php foreach ($documentaries as $key => $documentary): ?>
            ...
            <?php $count++; ?>
            <?php if ($count % 2 === 0 || $count === count($documentaries)): ?>
                </div> <!-- close row -->
            <?php endif; ?>
        <?php endforeach; ?>
    </div>
        ...
        <div class="col-md-6">
            <!-- Second column content goes here if needed -->
        </div>
    </div>
